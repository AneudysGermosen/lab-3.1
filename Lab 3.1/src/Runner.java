	...
	public static class MainMethod 
	{
		public static void main(String [] args)
		{
			...
			*/
			...
			double [] magnolia = {1.1, 4.1, 4.2, 5.0, 2.0, 4.0, 3.0, 17.0, 0.0};
			String [] safehouse = {"zebra", "tortilla", "abba", "foo", "bar", "aba"};
			
			long start = System.nanoTime();
			Sortingalgorithms.ISort(test1);
			...
			Sortingalgorithms.Ssort(magnolia);
			end = System.nanoTime();
			time = end - start;
			...
			start = System.nanoTime();
			Sortingalgorithms.bsort(safehouse);
			end = System.nanoTime();
			time = end - start;
			System.out.println("Test3 took: " + time + "nanoseconds");
			printArray(safehouse);
